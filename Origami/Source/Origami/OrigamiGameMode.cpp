...
void FConstructorStatics::Initialize()
{
	...
	ConstructorHelpers::FObjectFinderOptional<class UBlueprint> Obj_Stc_Cocoon_L_1(TEXT("Blueprint'/Game/Origami/Blueprints/Actors/Cocoons/Bt_Act_Cocoon_L_1.Bt_Act_Cocoon_L_1'"));
	Objects.Add(TEXT("/Game/Origami/Blueprints/Actors/Cocoons/Bt_Act_Cocoon_L_1.Bt_Act_Cocoon_L_1"), Obj_Stc_Cocoon_L_1.Get());

	ConstructorHelpers::FObjectFinderOptional<class UBlueprint> Obj_Stc_Cocoon_M_1(TEXT("Blueprint'/Game/Origami/Blueprints/Actors/Cocoons/Bt_Act_Cocoon_M_1.Bt_Act_Cocoon_M_1'"));
	Objects.Add(TEXT("/Game/Origami/Blueprints/Actors/Cocoons/Bt_Act_Cocoon_M_1.Bt_Act_Cocoon_M_1"), Obj_Stc_Cocoon_M_1.Get());

	ConstructorHelpers::FObjectFinderOptional<class UBlueprint> Obj_Stc_Cocoon_S_1(TEXT("Blueprint'/Game/Origami/Blueprints/Actors/Cocoons/Bt_Act_Cocoon_S_1.Bt_Act_Cocoon_S_1'"));
	Objects.Add(TEXT("/Game/Origami/Blueprints/Actors/Cocoons/Bt_Act_Cocoon_S_1.Obj_Stc_Cocoon_S_1"), Obj_Stc_Cocoon_S_1.Get());
